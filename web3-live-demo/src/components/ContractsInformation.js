...
import BuyBoosterCredits from './BuyBoosterCredits'
import BuyBoosterAndMintNFT from './BuyBoosterAndMintBooster';
  ...
  return (
    <div>
      ...
      <Grid mt={2} >
        ...
        <LogCardMinted spineRef={props.spineRef} acc={acc} zoombiesContract={contractZoombies}/>
      </Grid>
    </div>
  )
}
